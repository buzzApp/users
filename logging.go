...
func (mw userServiceLogginMiddleware) RefreshToken(userID, username, role, referer string) (model.JWTToken, error) {
	token, err := mw.UserService.RefreshToken(userID, username, role, referer)
	if err != nil {
